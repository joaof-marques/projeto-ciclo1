    ...
    def register_page(self):
        ...
        with tab_register:
                ...
                with st.form(key='signup', clear_on_submit=True):
                    ...
                    create_user_button = st.form_submit_button('Enviar', type='primary', on_click=self.register_store_user_credentials)
        ...
        with tab_delete_user:
            with st.form(key='delete_user', clear_on_submit=True):
                ...
                delete_user_button = st.form_submit_button('Excluir', type='primary', on_click=self.delete_store_user_credentials)
